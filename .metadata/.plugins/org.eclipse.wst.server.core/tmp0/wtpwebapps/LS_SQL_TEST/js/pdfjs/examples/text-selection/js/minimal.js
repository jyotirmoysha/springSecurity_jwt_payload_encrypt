// Minimal PDF rendering and text-selection example using PDF.js by 
...
window.onload = function () {
  ...
  PDFJS.workerSrc = 'https://contractreview.rageframeworks.com/contractreviewtest/js/pdfjs/src/worker_loader.js';
