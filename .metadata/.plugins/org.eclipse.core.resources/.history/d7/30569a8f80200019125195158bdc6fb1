		...
		!function($) {
		    ...
		    Multiselect.prototype = {
		        ...
		        defaults: {
		            ...
		            buttonWidth: 'auto',
		            buttonContainer: '<div class="btn-group col-lg-12 zeropad" />',
		        ...
		        // Templates.
		        templates: {
		            button: '<button type="button" class="multiselect dropdown-toggle btn btn-default btn-block cbtn" data-toggle="dropdown"></button>',
		            ul: '<ul class="UicMultiSelectContainer dropdown-menu"></ul>',
